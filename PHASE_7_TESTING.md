...
## ⚠️ Технический долг (отложено до Phase 8+)

**Оставшиеся unit тесты (30% Phase 7):**
- [ ] 🔴 **ДОЛГ:** Тесты для products service (~12-15 тестов)
  - CRUD operations, search, filters, promotions
- [ ] 🔴 **ДОЛГ:** Тесты для telegram service (~8-10 тестов)
  - Order notifications, welcome messages
- [ ] 🟡 Тесты для promocodes service (опционально)
- [ ] 🟡 Тесты для categories service (опционально)

**Integration тесты:**
- [ ] 🔴 **ДОЛГ:** Установить Supertest
- [ ] 🔴 **ДОЛГ:** Тесты API endpoints (~20-30 тестов):
...
**CI/CD Integration:**
- [ ] 🔴 **ДОЛГ:** Добавить запуск тестов в GitHub Actions
- [ ] 🔴 **ДОЛГ:** Настроить coverage репорты
- [ ] 🟡 Требование минимального покрытия (опционально)

**Приоритет:**
- 🔴 Критично - нужно доделать в Phase 8 или позже
- 🟡 Желательно - можно отложить

**Решение:** Переход к Phase 8 с возвратом к тестированию после setup мониторинга
