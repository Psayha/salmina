...
import { createCategory, getCategories } from '@/lib/api/endpoints/categories';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-light text-gray-900 dark:text-white">Новая категория</h1>
          <p className="text-sm font-light text-gray-600 dark:text-gray-300 mt-1">Добавление категории товаров</p>
        </div>
      </div>
