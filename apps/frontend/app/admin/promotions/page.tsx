    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          if (!from && !to) return <span className="text-xs text-gray-400">Бессрочно</span>;
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-light text-gray-900">Акции</h1>
          <p className="text-sm font-light text-gray-500 mt-1">Управление акциями и скидками</p>
        </div>
        <Link
          href="/admin/promotions/new"
          onClick={() => haptic?.impactOccurred('light')}
          className="flex items-center gap-2 px-4 py-2 bg-linear-to-r from-pink-500 to-pink-600 text-white rounded-xl hover:shadow-lg transition-all shadow-pink-500/20"
        >
