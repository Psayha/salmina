    ...
    <div className="space-y-6 pb-20">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-light text-gray-900 dark:text-white">Редактирование акции</h1>
            <p className="text-sm font-light text-gray-600 dark:text-gray-300 mt-1">Изменение параметров акции</p>
          </div>
        </div>
        <button onClick={handleDelete} className="p-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg text-red-500 transition-colors">
