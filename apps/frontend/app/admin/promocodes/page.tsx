      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 items-center">
          ...
          <button
            ...
            className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-teal-600 text-white rounded-xl hover:shadow-xl transition-all duration-300 shadow-lg shadow-cyan-500/30 flex-shrink-0"
          >
