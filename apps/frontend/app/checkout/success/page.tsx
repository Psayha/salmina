  ...
  return (
    <div className="min-h-screen relative z-10 flex items-center justify-center p-6">
      <div className="bg-white/40 dark:bg-white/10 backdrop-blur-md rounded-2xl p-12 border border-white/30 dark:border-white/10 shadow-lg text-center max-w-md">
        ...
        <h1 className="text-2xl font-light text-gray-900 dark:text-white mb-3">Заказ оформлен!</h1>
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => router.push('/')}
            className="w-full py-3 bg-white/30 dark:bg-white/10 backdrop-blur-md rounded-full border border-white/30 dark:border-white/10 text-sm font-light text-gray-700 dark:text-gray-300 hover:bg-white/40 dark:hover:bg-white/20 transition-all duration-300"
          >
            На главную
          </button>
        </div>
